...
impl Image {
    pub fn new(ui: &Rc<UI>,mat: Mat<pixel::ARGB8>) -> Result<Image,SystemError> {
        Ok(Image {
            ui: Rc::clone(ui),
            r: Cell::new(Rect::<i32>::zero()),
            texture: Texture2D::<pixel::ARGB8>::new_from_mat(&ui.state.graphics,mat)?,
...
impl Widget for Image {
    ...
    fn draw(&self) {
        self.ui.state.draw_texture(self.r.get().o(),&self.texture,BlendMode::Replace);
    }
