...
fn main() {
    ...
    let text1 = Rc::new(RefCell::new(ui::Text::new(&ui,"Sans 16",&sans16)));
    let text2 = Rc::new(RefCell::new(ui::Text::new(&ui,"Sans 32",&sans32)));
    let text3 = Rc::new(RefCell::new(ui::Text::new(&ui,"Serif 16",&serif16)));
    let text4 = Rc::new(RefCell::new(ui::Text::new(&ui,"Serif 32",&serif32)));
    let text5 = Rc::new(RefCell::new(ui::Text::new(&ui,"Mono 16",&mono16)));
    let text6 = Rc::new(RefCell::new(ui::Text::new(&ui,"Mono 32",&mono32)));
    ...
    let vstack = Rc::new(RefCell::new(ui::VStack::new_from_vec(&ui,vec![text1,text2,text3,text4,text5,text6])));
    vstack.borrow_mut().halign = ui::HAlignment::Center;

    // create more widgets
    let text8 = Rc::new(RefCell::new(ui::Text::new(&ui,"File",&ui.font)));
    let text9 = Rc::new(RefCell::new(ui::Text::new(&ui,"Edit",&ui.font)));
    let text10 = Rc::new(RefCell::new(ui::Text::new(&ui,"Selection",&ui.font)));
    let text11 = Rc::new(RefCell::new(ui::Text::new(&ui,"View",&ui.font)));
    ...
    // create HStack
    let hstack = Rc::new(RefCell::new(ui::HStack::new_from_vec(&ui,vec![text8,text9,text10,text11,vstack])));
    hstack.borrow_mut().valign = ui::VAlignment::Center;

    ui.open(&(hstack as Rc<RefCell<dyn ui::Widget>>),rect!(50,50,640,360),"Test Window");
    ui.run();        
}
