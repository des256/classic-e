...
impl Button {
    pub fn new(state: &Rc<ui::UIState>,text: &str,font: &Rc<ui::Font>) -> Button {
        Button {
            ...
            inner_padding: Vec2::<i32>::new(4,2),
        }
    }
}
...
impl ui::Widget for Button {
    ...
    fn draw(&self,context: Vec2<i32>) {
        ...
        self.state.draw_rectangle(Rect::<i32>::new_os(local_context + self.padding,self.r.get().s() - 2 * self.padding),bc,gpu::BlendMode::Replace);
