...
fn main() {
    ...
    text8.padding = Vec2::<i32>::new(4,2);
    text9.padding = Vec2::<i32>::new(4,2);
    text10.padding = Vec2::<i32>::new(4,2);
    text11.padding = Vec2::<i32>::new(4,2);
    
    // create HStack
    let hstack = Rc::new(ui::HStack::new_from_vec(&ui.state,vec![text8,text9,text10,text11,vstack]));
    //hstack.valign = ui::VAlignment::Center;

    ui.open_frame(Rect::<i32>::new(50,50,640,350),"HStack Test",&hstack);
